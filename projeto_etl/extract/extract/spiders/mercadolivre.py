    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            yield{
                ...
                'old_price':f'{prices[0]},{cents[0]}' if len(prices) and len(cents) > 0 else None,
                'new_price':f'{prices[0]},{cents[0]}' if len(prices) and len(cents)> 0 else None,
                ...
                'new_price_centavos':cents[1] if len(cents)> 0 else None,
